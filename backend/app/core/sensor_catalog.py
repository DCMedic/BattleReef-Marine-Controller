...
SENSOR_CATALOG: list[dict[str, Any]] = [
    ...
    {"sensor_key": "flow_return_main", "label": "Return Flow", "unit": "gph", "category": "flow", "description": "Independent flow rate through the main return line, used to verify return-pump operation."},
    ...
    {"sensor_key": "power_heater_main", "label": "Heater Power", "unit": "W", "category": "power", "description": "Independent heater circuit power measurement used to verify heater relay state."},
